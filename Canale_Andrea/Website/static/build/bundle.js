...
var app = (function () {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	async function doPost() {
    		...
    		}).then(response => response.json()).then(json => console.log('Response', json));
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			t2 = text("THECLOUD ti permette di creare delle cartelle e di aprirle ovunque, basta creare una stanza. è gestibile ");
    			br0 = element("br");
    			...
    			div3 = element("div");
    			div2 = element("div");
    			div2.textContent = "Il nostro servizio di assistenza per qualsiasi problema è aperto h24 tutta la settimana.";
    			t8 = space();
    			li2 = element("li");
    			t9 = text("contatti\n          ");
    			div5 = element("div");
    			...
    			t73 = text(" si occupa di creare cartelle virtuali, nelle quali ogni utente può salvare file o qualsiasi ");
    			br7 = element("br");
    			t74 = text(" altro contenuto.\n              Crea le tue cartelle accessibili ovunque, in totale sicurezza.");
    			t75 = space();
    			div11 = element("div");
    			t76 = space();
    			p1 = element("p");
    			...
    			if (!src_url_equal(script0.src, script0_src_value = "./particles.js")) attr_dev(script0, "src", script0_src_value);
    			add_location(script0, file$2, 4, 2, 170);
    			if (!src_url_equal(script1.src, script1_src_value = "./app.js")) attr_dev(script1, "src", script1_src_value);
    			...
    			if (!src_url_equal(img.src, img_src_value = "img/fine.png")) attr_dev(img, "src", img_src_value);
    			...
    			if (!src_url_equal(source.src, source_src_value = "video.mp4")) attr_dev(source, "src", source_src_value);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Registrati> was created with unknown prop '${key}'`);
    	});
